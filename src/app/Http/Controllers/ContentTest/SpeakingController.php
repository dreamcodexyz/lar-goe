...
class SpeakingController extends Controller
{
    ...
    */
    ...
    public function indexAction()
    {
        ...
        $data['base_router'] = 'content_test/speaking';
//        $customers = Customer::all();
        $model = ContentTest::paginate(100)->where('type', '1')->sortByDesc("id");
    ...
    public function saveAction(Request $request)
    {
        ...
        if($request->input('save_and_continue')){
            return redirect('content_test/speaking/edit/' . $model->id);
        }

        return redirect('content_test/speaking');
    }
