...
<div class="form-group">
    <label for="fname" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.name") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fphone" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.phone") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fschool" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.school") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="ffacebook" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.facebook") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="birthday" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.birthday") }}</label>
    <div class="col-sm-2">
...
<div class="form-group">
    <label class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.gender") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fnote" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.note") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="factive" class="col-sm-3 control-label">{{ __("goe::customer.form_attribute.active") }}</label>
    <div class="col-sm-9">
