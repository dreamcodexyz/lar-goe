                        ...
                        <table class="table table-hover demo-table-dynamic table-responsive-block dataTable no-footer" id="tableWithDynamicRows" role="grid" aria-describedby="tableWithDynamicRows_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="App name: activate to sort column descending" aria-sort="ascending">Tên học viên</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Kết quả</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Phân loại</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Ngày tháng</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($list_data as $data)
                                    ...
                                    <tr role="row" class="{{ $data->id % 2 == 0 ? 'odd' : 'event' }}">
                                        ...
                                        <td class="v-align-middle">
                                            <p class="text-center"><a href="{{ url('customer/result/edit/'.$data->id) }}">{{ __('common.edit') }}</a> | <a href="{{ url('customer/result/delete/'.$data->id) }}">{{ __('common.delete') }}</a></p>
                                        </td>
                                    </tr>
