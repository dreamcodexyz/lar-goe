            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form id="form_id" method="POST" action="{{ url('document/save') }}" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{!! $form_data->id !!}">

                            <div class="form-group">
                                <label for="fname" class="col-sm-3 control-label">{{ __("document.form_attribute.name") }}</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{!! $form_data->name !!}" id="fname" placeholder="{{ __("document.form_attribute.name") }}" name="name" required aria-required="true">
                                </div>
                            </div>


                            <div class="form-group">
                                <label for="ffacebook" class="col-sm-3 control-label">{{ __("document.form_attribute.address") }}</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{!! $form_data->address !!}" id="ffacebook" placeholder="{{ __("document.form_attribute.address") }}" name="address" required aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-3 control-label">{{ __("document.form_attribute.note") }}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="fstatus" class="col-sm-3 control-label">{{ __("document.form_attribute.active") }}</label>
                                <div class="col-sm-9">
