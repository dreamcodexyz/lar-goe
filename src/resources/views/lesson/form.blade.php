        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <a href="{{ url('lesson') }}"  class="btn btn-cons"><i class="fa fa-arrow-circle-left"></i> {{ __("common.back") }}</a>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form id="form_id" method="POST" action="{{ url('lesson/save') }}" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                            {{ csrf_field() }}
                            ...
                            {{--<div class="form-group">--}}
                                ...
                                {{--<div class="col-sm-9">--}}
                                    {{--<input type="text" class="form-control" value="{!! $form_data->class_id !!}" id="fclass" placeholder="{{ __("lesson.form_attribute.class") }}" name="teacher_id"  aria-required="true">--}}
                                {{--</div>--}}
                            {{--</div>--}}

                            {{--<div class="form-group">--}}
                                {{--<label for="fteacher" class="col-sm-3 control-label">{{ __("lesson.form_attribute.teacher") }}</label>--}}
                                {{--<div class="col-sm-9">--}}
                                    {{--<input type="text" class="form-control" value="{!! $form_data->teacher_id !!}" id="fteacher" placeholder="{{ __("lesson.form_attribute.teacher") }}" name="teacher_id"  aria-required="true">--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            ...
                            <div class="form-group">
                                <label for="fcontent_test" class="col-sm-3 control-label">{{ __("lesson.form_attribute.content_test") }}</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="content_test" id="fcontent_test" placeholder="" aria-invalid="false">{!! $form_data->content_test !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="fhomework" class="col-sm-3 control-label">{{ __("lesson.form_attribute.homework") }}</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="homework" id="fhomework" placeholder="" aria-invalid="false">{!! $form_data->homework !!}</textarea>
                                </div>
                            </div>
