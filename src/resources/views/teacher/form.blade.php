        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <a href="{{ url('teacher') }}"  class="btn btn-cons"><i class="fa fa-arrow-circle-left"></i> {{ __("common.back") }}</a>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form id="form_id" method="POST" action="{{ url('teacher/save') }}" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                            {{ csrf_field() }}
