        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                ...
                <div class="pull-right m-b-10">
                    <div class="col-xs-12">
                        <a href="{{ url('classes/new') }}" class="btn btn-default "><i class="fa pg-plus"></i>  {{ __('common.add_new') }}</a>
                        ...
                        <table class="table table-hover demo-table-dynamic table-responsive-block dataTable no-footer" id="tableWithDynamicRows" role="grid" aria-describedby="tableWithDynamicRows_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="App name: activate to sort column descending" aria-sort="ascending">Tên lớp</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Sỹ số</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Bắt đầu</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Kết thúc</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Chi nhánh</th>
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 100px;">Trạng thái</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($list_data as $data)
                                    ...
                                    <tr role="row" class="{{ $data->id % 2 == 0 ? 'odd' : 'event' }}">
                                        ...
                                        <td class="v-align-middle ">
                                            <p>{!! date('d-m-Y h:m', strtotime($data->start_time)) !!}</p>

                                        </td>
                                        <td class="v-align-middle ">
                                            <p>{!! date('d-m-Y h:m', strtotime($data->end_time)) !!}</p>
                                        </td>
                                        <td class="v-align-middle ">
                                            <p>{!! $data->store_id !!}</p>
                                        </td>
                                        <td class="v-align-middle">
                                            <p>
                                                @if (isset($status_options))
                                                    @foreach ($status_options as $val)
                                                        {{ $data->is_actived == $val['value'] ? $val['label'] : '' }}
                                                    @endforeach
                                                @endif
                                            </p>
                                        </td>
                                        ...
                                        <td class="v-align-middle">
                                            <p class="text-center"><a href="{{ url('classes/edit/'.$data->id) }}">{{ __('common.edit') }}</a> | <a href="{{ url('classes/delete/'.$data->id) }}">{{ __('common.delete') }}</a></p>
                                        </td>
                                    </tr>
