...
<div class="form-group">
    <label for="fpname" class="col-sm-3 control-label">{{ __("goe::parent.form_attribute.name") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fgphone" class="col-sm-3 control-label">{{ __("goe::parent.form_attribute.phone") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fpfacebook" class="col-sm-3 control-label">{{ __("goe::parent.form_attribute.facebook") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fpemail" class="col-sm-3 control-label">{{ __("goe::parent.form_attribute.email") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fpnote" class="col-sm-3 control-label">{{ __("goe::parent.form_attribute.note") }}</label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="fphope" class="col-sm-3 control-label">{{ __("goe::parent.form_attribute.hope") }}</label>
    <div class="col-sm-9">
