        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <a href="{{ url('customer/result') }}"  class="btn btn-cons"><i class="fa fa-arrow-circle-left"></i> {{ __("common.back") }}</a>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                ...
                <form id="form_id" method="POST" action="{{ url('customer/result/save') }}" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                    {{ csrf_field() }}
                            ...
                            <div class="tab-pane active" id="tab2hellowWorld">
                                <div class="row column-seperation">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                @include('customer_result.tab.general')
                                            </div>
                                        </div>
                                    </div>
                                </div>
