        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                ...
                <div class="pull-right m-b-10">
                    <div class="col-xs-12">
                        <a href="{{ url('extra_help/new') }}" class="btn btn-default "><i class="fa pg-plus"></i>  {{ __('common.add_new') }}</a>
                        ...
                        <table class="table table-hover demo-table-dynamic table-responsive-block dataTable no-footer" id="tableWithDynamicRows" role="grid" aria-describedby="tableWithDynamicRows_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="tableWithDynamicRows" rowspan="1" colspan="1" aria-label="Description: activate to sort column ascending" style="width: 100px;">Sinh nhật</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($list_data as $data)
                                    ...
                                    <tr role="row" class="{{ $data->id % 2 == 0 ? 'odd' : 'event' }}">
                                        ...
                                        <td class="v-align-middle">
                                            <p class="text-center"><a href="{{ url('extra_help/edit/'.$data->id) }}">{{ __('common.edit') }}</a> | <a href="{{ url('extra_help/delete/'.$data->id) }}">{{ __('common.delete') }}</a></p>
                                        </td>
                                    </tr>
