                    ...
                    <div class="col-sm-12">
                        ...
                        <form id="form_id" method="POST" action="{{ url('lesson/save') }}" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{!! $form_data->teacher_id !!}" id="fteacher" placeholder="{{ __("lesson.form_attribute.teacher") }}" name="teacher_id" required aria-required="true">
                                </div>
                            </div>
